...
<body>
                ...
                <div class="card-body p-md-5 card-pricipal" style="background-color: rgb(241, 234, 226);">
                  ...
                  <form>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <a href="#" target="_blank" class="botao"><img src="../../Imagem/editar.png" width="12" height="12"></a>
                    </div>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <a href="..\ems.php" target="_blank" class="botao"><img src="../../Imagem/editar.png" width="12" height="12"></a>
                      </div>
                      <div class="form-outline mb-4">
                      <label class="form-label" >Meus itens salvos </label>
                      <a href="#" target="_blank" class="botao"><img src="../../Imagem/linkExt.png" width="12" height="12"></a>
                      </div>
                      <label class="form-label" >Sair </label>
                      <a href="..\html\inicio.html" target="_blank" class="botao"><img src="../../Imagem/sair.png" width="12" height="12"></a>
                      </div>
  ...
  <footer class="main_footer">
    ...
    <div class="main_footer_copy">
      ...
      <p class="by" style="color: rgb(190, 115, 65);">Desenvolvido por: <a href="#"
